package pers.lzy.template.word.test.chinese;
...
public class ChineseTest {
    ...
    public void test() throws IOException, InvalidFormatException {
        ...
        // 将Excel 写出去，查看结果
        WordUtil.writeFile(doc, new File("C:\\Users\\immort\\Desktop\\fff\\people-info-chinese.docx"));
    }
    ...
    private Map<String, Object> initParam() {
        ...
        Map<String, Object> scoreZH = new HashMap<>();

        // 中文测试
        scoreZH.put("分数列表", scoreList);

        res.put("scoreZH", scoreZH);
        ...
        peopleProvinceList.add(new PeopleProvince("河南省", "开封市", "开封村", "扽给"));

...
public interface OperateTableCellHandler {
     ...
     */
    void operate(XWPFDocument document, XWPFTable table, XWPFTableRow row, XWPFTableCell cell, Map<String, Object> params, ExpressionCalculator expressionCalculator);
